...
public class ChainblockImpl implements Chainblock{
    ...
    public Iterable<Transaction> getByTransactionStatus(TransactionStatus status) {
        List<Transaction> transaction= this.database.values()
                .stream()
        ...
        transaction.sort((t1,t2)-> Double.compare(t2.getAmount(),t1.getAmount()));
        return transaction;
    ...
    public Iterable<String> getAllSendersWithTransactionStatus(TransactionStatus status) {
        ...
        return transactions.stream().map(t ->t.getFrom()).collect(Collectors.toList());
    }
    ...
    public Iterable<String> getAllReceiversWithTransactionStatus(TransactionStatus status) {
        ...
        return transactions.stream().map(t ->t.getTo()).collect(Collectors.toList());
    }
    ...
    public Iterable<Transaction> getBySenderOrderedByAmountDescending(String sender) {
        ...
        return transactions.stream(). sorted((t1,t2)-> Double.compare(t2.getAmount(),t1.getAmount())).collect(Collectors.toList());
    }
