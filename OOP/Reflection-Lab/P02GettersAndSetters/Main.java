package LabReflection.P02GettersAndSetters;
...
public class Main {
    public static void main(String[] args) throws NoSuchMethodException, InvocationTargetException,InstantiationException,IllegalArgumentException {
        ...
        Arrays.stream(setter).forEach(m->
